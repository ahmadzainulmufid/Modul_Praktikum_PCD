...
class ShowImage(QMainWindow):
    ...
    def konvolusi2D(self):
        ...
        img_input = cv2.imread('sedih.png')
    ...
    def medianFilter(self):
        ...
        plt.subplot(1, 2, 1), plt.imshow(cv2.cvtColor(img_input, cv2.COLOR_BGR2RGB))
    ...
    def deteksiTepi(self):
        #input image
        img_input = cv2.imread('noise2.jpg')
    ...
    def deteksiCanny(self):
        # Input image
        img_input = cv2.imread('mineral.jpg')
    ...
    def dilasi(self):
        img_input = cv2.imread('12.jpg', cv2.IMREAD_GRAYSCALE)
    ...
    def binary(self):
        img_input = cv2.imread('noise2.jpg', cv2.IMREAD_GRAYSCALE)
        T = 127
        max = 255
    ...
    def contourImage(self):
        ...
        img_input = cv2.imread('bangun.jpg')
        if img_input is None:
